...
# ============================
SESSION = environ.get('SESSION', 'Lootere_search')
...
Lootere_MOVIE_UPDATE_CHANNEL = int(environ.get('Lootere_MOVIE_UPDATE_CHANNEL', '-1002129955308'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002265223323'))  # Premium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002023191399')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1002265223323').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1002023191399').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://i.postimg.cc/x1TZCBc1/Whats-App-Image-2025-08-10-at-17-06-21-bcc51752.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'rkmovieszip@ybl')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Lootere_files')

# ============================
# Movie Notification & Update Settings
# ============================
Lootere_MOVIE_UPDATE_NOTIFICATION = bool(environ.get('Lootere_MOVIE_UPDATE_NOTIFICATION', False))  # Notification On (True) / Off (False)
Lootere_IMAGE_FETCH = bool(environ.get('Lootere_IMAGE_FETCH', True))  # On (True) / Off (False)
...
Lootere_VERIFY_EXPIRE = int(environ.get('Lootere_VERIFY_EXPIRE', 24))  # Add time in hours
Lootere_VERIFIED_LOG = int(environ.get('Lootere_VERIFIED_LOG', '-1002265223323'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/rkmovieszip')  # How to open tutorial link for verification
...
Lootere_MOVIE_UPDATE_CHANNEL_LNK = environ.get('Lootere_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/krish_filmy')
OWNERID = int(os.environ.get('OWNERID', '1798348973 '))  # Replace with the actual admin ID
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'LootereBot'))
MULTI_CLIENT = False
name = str(environ.get('name', 'Lootere'))
