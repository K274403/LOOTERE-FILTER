...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'Looteredhaked@ybl')
...
Lootere_VERIFIED_LOG = int(environ.get('Lootere_VERIFIED_LOG', '-1002370988072'))  # Log channel id (make sure bot is admin)
...
Lootere_MOVIE_UPDATE_CHANNEL_LNK = environ.get('Lootere_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/dreamcinezone')
