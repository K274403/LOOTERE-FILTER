...
from Lootere_botz.util.file_properties import get_name, get_hash, get_media_file_size
from database.config_db import mdb
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            Lootere = await query.message.reply_text(
...
#Lootere403
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🗣📢 ᴍᴏᴠɪᴇ ɴᴏᴛɪғɪᴄᴀᴛɪᴏɴ ', url=Lootere_MOVIE_UPDATE_CHANNEL_LNK),
        ],[
        ...
        buttons = [[
            InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ 📜', url='https://github.com/Lootere403/Lootere_dhakad.git'),
